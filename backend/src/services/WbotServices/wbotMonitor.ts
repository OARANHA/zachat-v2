...
/**
 * @deprecated wbotMonitor está depreciado.
 * O monitoramento de sessões WhatsApp agora é feito pelo gateway via webhooks.
 * Use o WhatsAppWebhookController para processar eventos do gateway.
 */
const wbotMonitor = async (
  ...
  logger.warn(`wbotMonitor está depreciado. Use eventos via WhatsAppWebhookController.`);
